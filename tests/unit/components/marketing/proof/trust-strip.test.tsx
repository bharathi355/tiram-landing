...
vi.mock("@/components/marketing/shell/motion-css", () => ({
  CssMarquee: ({ children, className }: { children: ReactNode; className?: string }) => (
    <div className={className}>{children}</div>
  ),
}));

import { TrustStrip } from "@/components/marketing/proof/trust-strip";
