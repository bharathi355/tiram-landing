...
export function Pricing() {
  ...
  const stepperId = "pricing-seat-stepper";
  ...
  const desktopWhatsappHref = supportWhatsappUrl(
    t("platforms.desktop.whatsappMessage"),
  );
  const enterpriseWhatsappHref = supportWhatsappUrl(
    t("enterprise.whatsappMessage"),
  );
            ...
            <article className="relative flex h-full flex-col overflow-hidden rounded-2xl border-2 border-accent-500 bg-white shadow-sm dark:border-accent-500/70 dark:bg-slate-900">
              ...
              <div className="flex-1 p-6">
                ...
                <p className="mt-3 border-t border-slate-100 pt-3 text-center text-xs text-slate-500 dark:border-slate-800 dark:text-slate-400">
                  ...
                  <a
                    data-testid="pricing-desktop-whatsapp-cta"
                    href={desktopWhatsappHref}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-semibold text-emerald-700 underline-offset-2 hover:text-emerald-800 hover:underline dark:text-emerald-300 dark:hover:text-emerald-200"
                  >
                    {t("platforms.desktop.whatsappCta")}
                    <MessageCircle
          ...
          <ScrollReveal direction="up" delay={0.15}>
            <article className="flex h-full flex-col rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
              <div className="flex-1 p-6">
                ...
                <a
                  data-testid="pricing-enterprise-whatsapp-cta"
                  href={enterpriseWhatsappHref}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-6 inline-flex h-10 w-full items-center justify-center gap-2 rounded-full border border-emerald-500 bg-emerald-500 px-5 text-sm font-semibold text-white shadow-sm shadow-emerald-500/20 transition hover:bg-emerald-600 dark:border-emerald-400 dark:bg-emerald-500 dark:text-slate-950 dark:hover:bg-emerald-400"
                >
                  {t("enterprise.cta")}
